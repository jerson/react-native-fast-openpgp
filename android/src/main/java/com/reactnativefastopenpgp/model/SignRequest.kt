...
class SignRequest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SignRequest {
        __init(_i, _bb)
        return this
    }
    val message : String?
    ...
    companion object {
        ...
        fun createSignRequest(builder: FlatBufferBuilder, messageOffset: Int, publicKeyOffset: Int, privateKeyOffset: Int, passphraseOffset: Int, optionsOffset: Int) : Int {
            ...
            return endSignRequest(builder)
        }
        fun startSignRequest(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endSignRequest(builder: FlatBufferBuilder) : Int {
